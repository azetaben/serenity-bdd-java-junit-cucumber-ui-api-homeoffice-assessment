...
public class PostcodeAPISteps {
    ...
    private final PostcodesApi postcodesApi = new PostcodesApi();

    @Given("the API service is healthy")
    public void verifyAPIHealth() {
        Response healthCheck = postcodesApi.get("/");
    ...
    public void lookupPostcode(String postcode) {
        response = postcodesApi.lookupPostcode(postcode);
    ...
    public void bulkLookupPostcodes(List<String> postcodes) {
        ...
        response = postcodesApi.bulkLookupPostcodes(postcodes);
    ...
    public void searchNearestPostcodes() {
        ...
        response = postcodesApi.nearestPostcodes(longitude, latitude);
